...
public class CityDao  implements ICityDao{
	...
	public void insertCity(City city) {
		...
		int id = jtm.update("insert into cities (name,rsdate) values(?,?)",city.getName(),city.getRsdate());
	...
	public void updateCity(City city) {
		...
		int val = jtm.update("update cities set rsdate=? where id=?",city.getRsdate(), city.getId());
	}
}
